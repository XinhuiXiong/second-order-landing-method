...
class Optimizer(metaclass=abc.ABCMeta):
    ...
    def _add_log_entry(self, *, time, iteration, point, cost, ortho_error, **kwargs):
        if self._log_verbosity <= 0:
            return
        self._log["iterations"]["time"].append(time)
        ...
        self._log["iterations"]["ortho_error"].append(ortho_error)
